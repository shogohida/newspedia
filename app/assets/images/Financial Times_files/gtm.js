...
return null},Ff=!1;if(I.querySelectorAll)try{var Gf=I.querySelectorAll(":root");Gf&&1==Gf.length&&Gf[0]==I.documentElement&&(Ff=!0)}catch(a){}var Cf=Ff;var Hd={},T=null,Uf=Math.random();Hd.B="GTM-NWQJW68";Hd.Rb="6h1";Hd.Sd="";var Vf={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Wf="www.googletagmanager.com/gtm.js";
var Xf=Wf,Yf=null,Zf=null,$f=null,ag="//www.googletagmanager.com/a?id="+Hd.B+"&cv=23",bg={},cg={},dg=function(){var a=T.sequence||0;T.sequence=a+1;return a};
...
zb:a.wg,domain:a.vg,flags:a.fi});var w=sh[th(a.Qa)];w&&d("auiddc",w)}Dk(a.rd)&&d("prd",a.rd,!0);Na(a.Cd,function(A,B){d(A,B)});n.push(b||"");if(Dk(a.oc)){var y=a.oc||"";m&&(y=Wg(y));d("~oref",y)}var x=g+n.join("")+"?";f?Ue(x,a.F):Ve(x,a.F,a.D)}else K(a.D)},Fk=encodeURIComponent,Hk=function(a,b){var c=!1;c=!0;c&&rf()?Bf(function(){Gk(a,b);yf(G.s)||
...
Z.b.f=["google"],function(){(function(a){Z.__f=a;Z.__f.g="f";Z.__f.h=!0;Z.__f.priorityOverride=0})(function(a){var b=V("gtm.referrer",1)||I.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?Tg(Vg(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):ao(String(b)):String(b)})}();Z.b.k=["google"],function(){(function(a){Z.__k=a;Z.__k.g="k";Z.__k.h=!0;Z.__k.priorityOverride=0})(function(a){return eo(a.vtp_name,V("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
